...
<head>
    <meta charset="UTF-8">
    <meta name="check_2FA" content="width=device-width, initial-scale=1.0">
    ...
    <div class="container-body">
        ...
        <div id="container-left-side">
            <div id="container-left-side-items">
                <form id="signUpForm" method="post" action="../services/userProvider/check2FACode.php">
                    <h1>Code Eingeben</h1>
                    <p>Schauen Sie in Ihre 2FA App:</p>
                    <div class="form-row">
                    ...
                    <br>
                    <div class="form-row">
                        <a id="rejectText" href="homepage.php">
                            <p>abbrechen</p>
                        </a>
