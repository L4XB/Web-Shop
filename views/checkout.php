...
<head>
    <meta charset="UTF-8">
    <meta name="checkout" content="width=device-width, initial-scale=1.0 shrink-to-fit=no">
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        if (response != 0) {
                            ...
                            var discountText = discount + "% Rabatt auf deine Bestellung";
...
<body class="bg-light">
    ...
    <div class="container pt-4" style="margin-left: 12%;">
        <div class="col-lg-6 order-2 order-lg-1">
            <h1>Rechnungsadresse und Zahlungsart</h1>
        </div>
        <ul class="breadcrumb undefined">
            <li class="breadcrumb-item"><a href="homepage.php" class="text-dark">Home</a></li>
            <li class="breadcrumb-item"><a href="warenkorb.php" class="text-dark">Warenkorb</a></li>
            <li class="breadcrumb-item active"><span class="text-dark">Bestellung</span></li>
        </ul>
    </div>
                ...
                -->
                    ...
                    <div class="d-block my-3">
                        <div class="custom-control custom-radio">
                            <input id="DPD" name="shippingMethod" value="DPD" type="radio" class="custom-control-input"
                                checked="" required="">
                            <label class="custom-control-label" for="dpd">DPD</label>
                        </div>
                        <div class="custom-control custom-radio">
                            <input id="DHL" name="shippingMethod" type="radio" value="DHL" class="custom-control-input"
                                required="">
                    ...
                    <div class="d-block my-3">
                        <div class="custom-control custom-radio">
                            ...
                            <label class="custom-control-label" for="credit">Kreditkarte <svg
                        ...
                        <div class="custom-control custom-radio">
                            ...
                            <label class="custom-control-label" for="paypal">Paypal <svg
                                    xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
