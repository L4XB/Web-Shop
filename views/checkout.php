    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <ul class="list-group mb-3">
                ...
                <div>
                    <h6 class="my-0">Prokukt A</h6>
                    <small class="text-muted">kurze Beschreibung...</small>
                </div>
                <span class="text-muted">{Preis!}€</span>
                </li>
                <li class="list-group-item d-flex justify-content-between lh-condensed">
                <div>
                    <h6 class="my-0">Prokukt B</h6>
                    <small class="text-muted">kurze Beschreibung...</small>
                </div>
                <span class="text-muted">{Preis!}€</span>
                </li>
                ...
                <div class="text-success">
                    <h6 class="my-0">Gutschein</h6>
                    <small>GUTSCHEINCODE</small>
                </div>
                <span class="text-success">-{Rabatt!}</span>
                </li>
            ...
            <form class="needs-validation was-validated" novalidate="">
                ...
                <input type="email" class="form-control" id="email" placeholder="inf.fachschaft@reutlingen-university.de" required="">
                <div class="invalid-feedback">
                    Bitte geben Sie eine korrekte Emailadresse an, damit wir Sie über Ihre Lieferung informieren können.
                </div>
                </div>

                <div class="mb-3">
                <label for="address">Straße, Hausnummer</label>
                <input type="text" class="form-control" id="address" placeholder="Alteburgstraße 105" required="">
                <div class="invalid-feedback">
                ...
                <input type="text" class="form-control" id="address2" placeholder="72762 Reutlingen" required="">
                    <div class="invalid-feedback">
                ...
                <div class="row container-fluid justify-content-end">
                    <hr class="mb-4">
                    <button class="btn btn-warning btn-lg btn-block" href="thankyou.php" type="submit">Zahlungspflichtig bestellen</button>
                </div>
