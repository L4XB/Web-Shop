...
<body>
    ...
    <main class="container">
        <div class="bg-body-tertiary p-5 rounded">
            ...
            <p class="lead"> Allgemeine Geschäftsbedingungen der Fachschaft Informatik der Hochschule Reutlingen <br><br>
            <strong>E-Mail:</strong> <a href="mailto: inf.fachschaft@reutlingen-university.de" class="text-dark">inf.fachschaft@reutlingen-university.de</a> <br><br>
            nachstehend als Verkäufer bezeichnet.
            </p>
            <br>
            <h3>§ 1 Allgemeines, Begriffsbestimmungen</h3>
            <p class="lead">(1) Die folgenden Allgemeinen Geschäftsbedingungen (AGB) gelten für die Geschäftsbeziehung zwischen dem Verkäufer und dem Kunden in ihrer zum Zeitpunkt der Bestellung gültigen Fassung. <br><br>
                (2) Verbraucher ist jede natürliche Person, die ein Rechtsgeschäft zu Zwecken abschließt, die überwiegend weder ihrer gewerblichen noch ihrer selbstständigen beruflichen Tätigkeit zugerechnet werden können. Unternehmer i. S. d. Geschäftsbedingungen sind natürliche oder juristische Personen oder rechtsfähige Personengesellschaften, die bei Abschluss des Rechtsgeschäfts in Ausübung ihrer gewerblichen oder selbständigen beruflichen Tätigkeit handeln. Kunden i. S. d. Geschäftsbedingungen sind sowohl Verbraucher als auch Unternehmer. <br><br>
                (3) Abweichende, entgegenstehende oder ergänzende Allgemeine Geschäftsbedingungen werden, selbst bei Kenntnis, nicht Vertragsbestandteil, es sei denn, ihrer Geltung wird ausdrücklich zugestimmt. <br><br>
            ...
            <p class="lead">(1) Der Kunde kann für die Zahlung aus verschiedenen Zahlungsarten wählen, wobei stets eine gängige und unentgeltliche Zahlungsart angeboten wird. Der Verkäufer behält sich vor, einzelne Zahlungsarten auszuschließen. Die konkret zur Verfügung stehenden Zahlungsarten ergeben sich allein aus den Auswahlmöglichkeiten auf unserer Webseite während des Bestellvorgangs; aus der nachstellenden Darstellung ergibt sich kein Anspruch auf eine bestimmte Zahlungsart, wenn Ihnen diese nicht während des Bestellvorgangs angezeigt wird. <br><br>
                (2) Zahlungsart PayPal <br><br>
                Bei Auswahl der Zahlungsart PayPal erfolgt eine automatische Weiterleitung zu dem Online-Bezahldienst PayPal (Europe) S.à r.l. et Cie, S.C.A., 22-24 Boulevard Royal, L-2449 Luxembourg. Es gelten in diesem Fall die PayPal-Nutzungsbedingungen, welche der Kunde unter <br><br>
                <a href="https://www.paypal.com/de/webapps/mpp/ua/useragreement-full" class="text-dark">https://www.paypal.com/de/webapps/mpp/ua/useragreement-full </a><br>
                <a href="https://www.paypal.com/de/webapps/mpp/ua/legalhub-full?locale.x=de_DE" class="text-dark">https://www.paypal.com/de/webapps/mpp/ua/legalhub-full?locale.x=de_DE </a><br>
                oder - sofern kein PayPal-Konto vorliegt, unter <br><br>
                <a href="https://www.paypal.com/de/webapps/mpp/ua/privacywax-full" class="text-dark">https://www.paypal.com/de/webapps/mpp/ua/privacywax-full </a><br>
