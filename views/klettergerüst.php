  ...
  <footer class="footer">
    <div class="container">
      <div class="row">
        ...
        <div class="col-2">
          <a class="footerlink nav-link px-2 text-white" href="devteam.php"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
        ...
        <div class="col-2" style="text-align: left;">
          <a class="footerlink nav-link px-2 text-white" href="kontakt.php"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
