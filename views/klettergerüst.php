...
<body>
  ...
  $stmt = $conn->prepare("SELECT COUNT(*) AS count FROM shoppingCart WHERE userID = ?");
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-2" style="text-align: right;">
          <a class="footerlink" href="doku.php"><img height="20px"
              src="https://cdn.icon-icons.com/icons2/2429/PNG/512/figma_logo_icon_147289.png"> Doku</a>
        </div>
        <div class="col-2">
          <a class="footerlink" href="devteam.php"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
        ...
        <div class="col-2" style="text-align: left;">
          <a class="footerlink" href="kontakt.php"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
