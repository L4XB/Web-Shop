...
<head>
  ...
  <body>
            ...
            <div class="col d-flex justify-content-center">
              <ul class="nav justify-content-end nav-underline">
                ...
                <li class="nav-item dropdown">
                  <a class="nav-link px-2 text-white dropdown-toggle" data-bs-toggle="dropdown" href="#" role="button" aria-expanded="false">
    ...
    <!-- Footer -->
    <footer class="footer">
      <nav class="navbar sticky-bottom navbar-expand-lg bg-body-tertiary bg-dark border-bottom border-body" data-bs-theme="dark">
        <div class="container-fluid">
          <div class="col justify-content-start">
            <ul class="nav nav-underline">
              <li class="nav-item">
                <a class="nav-link px-2 text-white" href="#">
                  ...
                  <div><img height="20px"
                    src="https://cdn.icon-icons.com/icons2/2429/PNG/512/figma_logo_icon_147289.png"> Doku</div>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link px-2 text-white" href="#">
              ...
              <li class="nav-item">
                <a class="nav-link px-2 text-white " href="#">
                  ...
                  <div><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-chat-dots" viewBox="0 0 16 16">
          ...
          <div class="col d-flex justify-content-end align-items-center">
            <p class="fw-medium text-light">Copyright &copy; <?php echo date('Y'); ?> Fachschaft Informatik Reutlingen</p>
          </div>   
        </div>
      </nav>
    </footer>
